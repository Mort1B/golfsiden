...
export function ScoreSelectors(props: ScoreSelectorsProps) {
  return (
    <section aria-label="Velg scorekort">
      <div className="score-selectors score-hole-controls">
      ...
      <details className="score-context">
        <summary>Bytt turnering, runde eller spiller/lag</summary>
