...
export default defineConfig({
  testDir: './e2e', testMatch: ['routeSplitting.browser.ts', 'matchCancellation.browser.ts', 'matchResultGate.browser.ts', 'returnLoading.browser.ts', 'returnOrdering.browser.ts'],
