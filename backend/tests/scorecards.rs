...
('30000000-0000-0000-0000-000000000009', '30000000-0000-0000-0000-000000000006', '30000000-0000-0000-0000-000000000001', 'Individual Group'),
...
('30000000-0000-0000-0000-000000000009', '30000000-0000-0000-0000-000000000006', '30000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000011', 1),
('30000000-0000-0000-0000-000000000009', '30000000-0000-0000-0000-000000000006', '30000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000012', 2),
...
async fn team_summary_and_api_conflicts_are_format_and_round_specific(pool: PgPool) {
    ...
    let cross_round = app
        ...
        .oneshot(save_request(
            SCRAMBLE_ROUND_ID,
            HOLE_2,
            json!({"type": "team", "id": INDIVIDUAL_TEAM_ID}),
            4,
            USER_A,
        ))
        .await
